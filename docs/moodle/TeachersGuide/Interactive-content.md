...
<!--[Install the H5P plugin](https://raw.githubusercontent.com/LEARN-LK/lms/master/Install-H5P-plugin.md)-->

<h1>01 - Create an H5P activity</h1>

[Create an H5P activity](https://raw.githubusercontent.com/LEARN-LK/lms/master/Create-H5P-activity.md)
